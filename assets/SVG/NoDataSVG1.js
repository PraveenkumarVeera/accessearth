...
import Svg, { Circle, Rect, Polygon, Defs, RadialGradient, Stop, LinearGradient} from "react-native-svg";
    ...
    <Svg width="60" height="60" viewBox="0 0 100 200" xmlns="http://www.w3.org/2000/svg">
      <Defs>
        ...
        <RadialGradient id="metallicRedSphereGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <Stop offset="10%" stopColor="#bfbfbf" stopOpacity="1" />
